...
int main() {
...

    {
        ...
        cout
                << "Supplier#000000003|1|11-383-516-1199 4192.400000 furiously regular instructions impress slyly! carefu|\n\n";
...

    {
        ...
        RegularSelection myOp(supplierTableL, supplierTableOut,
                              "&& (== ([l_nationkey], int[1]), > ([l_name], string [Supplier#000009378]))",
                              projections);
        myOp.run();
        ...
        while (myIter->advance()) {
            ...
            if (first) {
                ...
                string s = ss.str();
                QUNIT_IS_EQUAL (s,
                                "Supplier#000009428|1|11-896-966-5146 5429.370000 furiously regular pinto beans caj|");
            }
            cout << temp << "\n";
        }
    ...
    MyDB_BPlusTreeReaderWriterPtr supplierTableR = make_shared<MyDB_BPlusTreeReaderWriter>("r_address", myTableRight,
                                                                                           myMgr);
    MyDB_TablePtr myTableRightNoBPlus = make_shared<MyDB_Table>("supplierRightNoBPlus", "supplierRightNoBPlus.bin",
                                                                mySchemaR);
...

    {
        ...
        BPlusSelection myOp(supplierTableR, supplierTableOut, low, high,
                            "&& (&& ( > ([r_address], string[aa]), < ([r_address], string[ab])), > ([r_name], string[Supplier#000009000]))",
                            projections);
        ...
        int count = 0;
        cout
                << "This should return 32 copies of 'Supplier#000009436|aaY,0sdTlrtKjse|I love comments! unusual, regular...'"
                << "\n";
        while (myIter->advance()) {
            myIter->getCurrent(temp);
            cout << temp << "\n";
...

    {
        ...
        while (myIter->advance()) {
            ...
            ss << temp;
            string s = ss.str();
            if (s == "5|Supplier#000000005|5.000000|-283.840000|32|")
                hasFive = true;
...

        {
            ...
            QUNIT_IS_TRUE(hasZero);
            QUNIT_IS_TRUE(hasHundred);
